    ...
    //L Key?
     case 38: {
        ...
        if (_shift && playerSide in [west,independent]) then {
            if (!(isNull objectParent player) && (typeOf vehicle player) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Van_02_medevac_F","C_Hatchback_01_sport_F","C_Offroad_02_unarmed_F","B_Heli_Light_01_F","C_Offroad_01_covered_F","I_Heli_light_03_unarmed_F","B_Heli_Transport_01_F"]) then {

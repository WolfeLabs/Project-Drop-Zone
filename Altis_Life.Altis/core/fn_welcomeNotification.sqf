...
_message = _message + "<a color='#00DFFF'>•</a> Discord: <a href='https://discord.me/pdzaltis' color='#56BDD6'>https://discord.me/pdzaltis</a><br />";
_message = _message + "Rules, Laws, and all useful information can be found in discord.<br />";
_message = _message + "Admins are always active in discord, and will always be willing to help!<br />";

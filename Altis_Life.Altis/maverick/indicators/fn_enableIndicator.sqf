...
if (_ind == "left") then {
	...
	_light_front_left = "#lightpoint" createVehicleLocal [1,1,1];
	...
	_light_back_left = "#lightpoint" createVehicleLocal [1,1,1];
...
if (_ind == "right") then {
	...
	_light_front_right = "#lightpoint" createVehicleLocal [1,1,1];
	...
	_light_back_right = "#lightpoint" createVehicleLocal [1,1,1];

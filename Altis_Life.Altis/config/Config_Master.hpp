...
/* Database Related Settings */
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","ziptie", "gag", "blindfold" };
...
/* System Settings */
    ...
    service_chopper = 2500; //Cost to service chopper at chopper service station(Repair/Refuel).
    ...
    jail_seize_vItems[] = { "spikeStrip","lockpick","goldbar","blastingcharge","boltcutter","defusekit","heroin_unprocessed","heroin_processed","cannabis","marijuana","MedWeed","cocaine_unprocessed","cocaine_processed","mdma_ecstasy","ecstasy","Methi","Methp","turtle_raw","ziptie","gag","blindfold" }; //Define VIRTUAL items you want to be removed from players upon jailing here. Use "jail_seize_inventory" for Arma inventory items.
    ...
    playing_RewardPeriod = 30; // scaled in minutes 
